"""Canonical critical-points stage for the PAM topology pipeline."""
...
def run_critical_points(
    ...
    crit_pts = df.sort_values("criticality", ascending=False).head(top_k).copy()
