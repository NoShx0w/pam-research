...
"""
fim_figure_1_geometric_structure_v4_final.py

Final polished Figure 1 — Geometric structure of the state space.

Changes from v3:
- ridge in panel D is clamped above zero to avoid hard floor artifact
- ridge in panel A uses power transform for sharper boundary emphasis
- panel titles use more formal, consistent vocabulary
- panel D colorbar wording tightened
- global interpretive subtitle added under the main title
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Render final polished Figure 1 opener (v4).")
    parser.add_argument(
    ...
    outpath = outdir / "figure_1_geometric_structure_v4_final.png"
