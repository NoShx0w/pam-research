...
def main():
    ...
    # Lazarus heuristic:
    # high curvature + low distance_to_seam + low |signed_phase| (still near the seam but not collapsed)
    ...
    thresh = float(df["lazarus_score"].quantile(args.threshold_quantile))
